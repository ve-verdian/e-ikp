    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><b>LAPORAN INSIDEN KESELAMATAN PASIEN</b></h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-danger">
                <div class="card-header">
                  <h3 class="card-title"><i class="fa fa-archive" aria-hidden="true"></i> Formulir Data IKP</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?=base_url('admin/proses_databarang_masuk_insert')?>" role="form"
                  ...
                  <div class="card-body">
                  <p><b>I. DATA KARAKTERISTIK PASIEN</b></p>
                    <div class="form-row">
                      ...
                      <label for="ruangan">Ruangan</label>
                        <input type="number" name="nama_barang" class="form-control"
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Sebutkan . . . "></textarea>
                        </div> 
                      <div class="form-group col-md-6">
                        <label for="jns_insiden">Jenis Insiden*</label>
                        <select name="jns_insiden" class="form-control">
                          <option value="" selected="">-- Pilih --</option>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select name="Insiden_terjadi" class="form-control">
                          <option value="" selected="">-- Pilih --</option>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select name="probalitas" class="form-control">
                          <option value="" selected="">-- Pilih --</option>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select name="melaporkan" class="form-control">
                          <option value="" selected="">-- Pilih --</option>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select name="menyangkut" class="form-control">
                          <option value="" selected="">-- Pilih --</option>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="tempat" class="form-control" id="jumlah"
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="form-group col-md-12">
                        <p>Apabila Ya, isi bagian dibawah ini.</p>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <p><b>NB * : Pilih satu jawaban</p>
                        <p>Tipe Insiden : diisi setelah dilakukan investigasi.</b></p>
                      </div>
