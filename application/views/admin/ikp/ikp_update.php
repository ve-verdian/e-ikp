                ...
                <form class="form-horizontal" action="<?=base_url('admin/ikp_update')?>" role="form"
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" name="kronologi" id="kronologi" rows="3" placeholder="Sebutkan . . . " value="<?=$dikp->kronologi?>"></textarea>
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <textarea class="form-control" name="tindaklanjut" id="tindaklanjut" rows="3" placeholder="Sebutkan . . . "  value="<?=$dikp->tindaklanjut?>"></textarea>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" name="no_ulang" id="no_ulang" rows="3" placeholder="Sebutkan . . . " value="<?=$dikp->no_ulang?>"></textarea>
