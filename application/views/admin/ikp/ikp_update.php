                  ...
                  <span><b>I. DATA KARAKTERISTIK PASIEN</b></span>
                      ...
                      <label for="nama">Nama</label>
                        <input type="text" name="nama" class="form-control"
                          id="nama" placeholder="Nama" tabindex="1" value="<?=$dikp->nama?>">
                          <?= form_error('nama', '<small class="text-danger pl-3">', '</small>') ?>
                      </div>
                      <div class="form-group col-md-3">
                      <label for="no_mr">No. MR</label>
                        <input type="number" name="no_mr" class="form-control"
                          id="no_mr" placeholder="Nomor Medical Record" tabindex="2" value="<?=$dikp->no_mr?>">
                          <?= form_error('no_mr', '<small class="text-danger pl-3">', '</small>') ?>
                      </div>
                      <div class="form-group col-md-3">
                      <label for="ruangan">Ruangan</label>
                        <input type="text" name="ruangan" class="form-control"
                          id="ruangan" placeholder="Ruangan" tabindex="3" value="<?=$dikp->ruangan?>">
                          <?= form_error('ruangan', '<small class="text-danger pl-3">', '</small>') ?>
                      </div>
                      <div class="form-group col-md-1">
                      <label for="umur">Umur</label>
                        <input type="text" name="umur" class="form-control"
                          id="umur" placeholder="Umur" tabindex="4" value="<?=$dikp->umur?>">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="date" name="tanggal_1"  class="form-control"
													id="tanggal_1" placeholder="Tanggal Mendapatkan Pelayanan" tabindex="7" value="<?=$dikp->tanggal_1?>">
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <input type="time" name="waktu_1"  class="form-control"
													id="waktu_1" placeholder="Pukul" tabindex="8" value="<?=$dikp->waktu_1?>">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        ...
                        <input type="date" name="tanggal_2"  class="form-control"
													id="tanggal_2" placeholder="Tanggal dan Waktu Insiden"  tabindex="9" value="<?=$dikp->tanggal_2?>">
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <input type="time" name="waktu_2"  class="form-control"
													id="waktu_2" placeholder="Pukul" tabindex="10" value="<?=$dikp->waktu_2?>">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="insiden" class="form-control"
                          id="insiden" placeholder="Insiden" tabindex="11" value="<?=$dikp->insiden?>">
                          <?= form_error('insiden', '<small class="text-danger pl-3">', '</small>') ?>
                      </div>
                      <div class="form-group col-md-12">
                        <label for="kronologi">Kronologi</label>
                        <input type="text" class="form-control" type="text" name="kronologi" id="kronologi" tabindex="12" value="<?=$dikp->kronologi?>" rows="3" placeholder="Sebutkan . . . " >
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="tempat" class="form-control" id="tempat"
												placeholder="Lokasi Kejadian (Tempat Pasien Berada)" tabindex="19" value="<?=$dikp->tempat?>">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="unit_terkait" class="form-control" id="unit_terkait"
												placeholder="Unit Kerja Penyebab" tabindex="20" value="<?=$dikp->unit_terkait?>">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input type="text" class="form-control" type="text" name="tindaklanjut" id="tindaklanjut" tabindex="21" value="<?=$dikp->tindaklanjut?>" rows="3" placeholder="Sebutkan . . . " >
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" type="text" name="no_ulang" id="no_ulang" tabindex="24" value="<?=$dikp->no_ulang?>" rows="3" placeholder="Sebutkan . . . ">
                      ...
                      <label for="petugas">Petugas yang membuat laporan</label>
                        <input type="text" name="petugas" class="form-control"
                          id="petugas" placeholder="Petugas yang membuat laporan" tabindex="25" value="<?=$dikp->petugas?>">
                      ...
                      <label for="karu">Kepala Ruang/Unit/Bidang</label>
                        <input type="text" name="karu" class="form-control"
                          id="karu" placeholder="Kepala Ruang/Unit/Bidang" tabindex="26" value="<?=$dikp->karu?>">
                      ...
                      <label for="kmrkp">Ketua KMRKP</label>
                        <input type="text" name="kmrkp" class="form-control"
                          id="kmrkp" placeholder="Ketua KMRKP" tabindex="27" value="<?=$dikp->kmrkp?>">
                      ...
                      <label for="direktur">Direktur</label>
                        <input type="text" name="direktur" class="form-control"
                          id="direktur" placeholder="Direktur" tabindex="28" value="<?=$dikp->direktur?>">
                    ...
                    <div class="card-footer">
                      ...
                      <button type="submit" class="btn btn-success" tabindex="30"><i class="far fa-save"></i> Simpan</button>
